  ...
  try {
    ...
    switch (action) {
      case 'generate_subject':
        return await handleGenerateSubject(body);
      case 'generate_copy':
        return await handleGenerateCopy(body);
      case 'analyze_content':
        return await handleAnalyzeContent(body);
      case 'generate_ab_variants':
        return await handleGenerateABVariants(body);
      case 'generate_flow_emails':
        return await handleGenerateFlowEmails(body);
      case 'chat':
...
// ═══════════════════════════════════════════════════════════════
async function handleGenerateSubject(body: any): Promise<Response> {
...
// ═══════════════════════════════════════════════════════════════
async function handleGenerateCopy(body: any): Promise<Response> {
...
// ═══════════════════════════════════════════════════════════════
async function handleAnalyzeContent(body: any): Promise<Response> {
...
// ═══════════════════════════════════════════════════════════════
async function handleGenerateABVariants(body: any): Promise<Response> {
...
// ═══════════════════════════════════════════════════════════════
async function handleGenerateFlowEmails(body: any): Promise<Response> {
