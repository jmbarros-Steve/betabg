...
CREATE INDEX IF NOT EXISTS idx_qa_log_check_type ON qa_log(check_type, checked_at DESC);
CREATE INDEX IF NOT EXISTS idx_qa_log_status ON qa_log(status) WHERE status = 'fail';
