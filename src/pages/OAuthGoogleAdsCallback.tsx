...
export default function OAuthGoogleAdsCallback() {
  ...
  useEffect(() => {
    async function handleCallback() {
      ...
      const clientId = state || sessionStorage.getItem('google_ads_oauth_client_id');
      ...
      try {
        ...
        const { data, error: fnError } = await supabase.functions.invoke('google-ads-oauth-callback', {
          body: {
            code,
            client_id: clientId,
        ...
        setStatus('success');
        sessionStorage.removeItem('google_ads_oauth_client_id');
        ...
        <CardContent className="pt-6 text-center space-y-4">
          ...
          {status === 'loading' && (
            <>
              ...
              <p className="text-lg font-medium">Conectando con Google Ads...</p>
          ...
          {status === 'success' && (
            <>
              ...
              <p className="text-sm text-muted-foreground">
                Tu cuenta de Google Ads ha sido conectada correctamente
              </p>
