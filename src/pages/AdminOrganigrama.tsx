...
const AGENTS: AgentInfo[] = [
  ...
  {
    code: 'w6', name: 'Isidora', squad: 'qa', module: 'CRITERIO',
    icon: Shield,
    whatSimple: 'Mantiene 493 reglas de calidad que evalúan cada campaña y email antes de aprobarlos',
  ...
  {
    code: 'w12', name: 'Javiera', squad: 'qa', module: 'El Chino (QA)',
    icon: AlertTriangle,
    whatSimple: 'Audita todo: 800 checks diarios, reconciliación de datos, health monitoring',
