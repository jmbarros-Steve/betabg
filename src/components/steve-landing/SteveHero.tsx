...
export function SteveHero({ onOpenAuth }: SteveHeroProps) {
  return (
    <section className="relative bg-[#0F172A] overflow-hidden pt-24 pb-20 md:pt-32 md:pb-28">
      ...
      <div className="absolute left-[-200px] bottom-[-100px] w-[400px] h-[400px] bg-[#38BDF8]/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-slate-500">
              {['Todo incluido', 'Reunion sin compromiso', 'Setup en 5 min'].map((text) => (
          ...
          >
            <div className="relative">
              {/* Glow behind video */}
              <div className="absolute -inset-4 bg-gradient-to-br from-[#1E3A7B]/20 via-[#38BDF8]/10 to-transparent rounded-3xl blur-2xl" />
              {/* Video container */}
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-[#1E3A7B]/20 border border-white/10">
                <video
                  autoPlay
                  loop
                  muted
                  ...
                  poster="/logo-steve.png"
                >
                  <source src="/steve-demo.webm" type="video/webm" />
                </video>
              </div>
            </div>
          </motion.div>
