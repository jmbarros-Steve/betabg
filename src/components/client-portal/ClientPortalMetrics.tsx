...
export function ClientPortalMetrics({ clientId }: ClientPortalMetricsProps) {
  ...
  const statCards = useMemo(() => [
    ...
    { title: 'Inversión Publicitaria', value: `$${totalAdSpendWithGoogle.toLocaleString('es-CL')}`, currentNum: totalAdSpendWithGoogle, prevValue: prevTotalAdSpendWithGoogle, icon: Target, color: 'text-[#1E3A7B]', tooltip: 'Gasto total en publicidad (Meta + Google) en el período', formatter: currencyFormatter },
