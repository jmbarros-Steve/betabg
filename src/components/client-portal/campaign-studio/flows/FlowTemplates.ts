...
export const FLOW_TEMPLATES: FlowTemplate[] = [
  // 1. Welcome Series (critical, lifecycle)
  {
    ...
    emails: [
      ...
      },
      {
        ...
        delayHours: 48,
        description: 'Cuenta la historia de la marca, valores y misión para crear conexión emocional.',
        purpose: 'Construir confianza y conexión emocional con la marca.',
      },
      {
        subject: 'Lo que más eligen nuestros clientes',
        previewText: 'Productos favoritos con reseñas reales',
        delayHours: 96,
        description: 'Muestra los productos más vendidos con reseñas y prueba social.',
        purpose: 'Reducir fricción mostrando lo que otros ya compraron y aprobaron.',
      },
      {
  ...
  // 2. Abandoned Cart (critical, revenue)
  {
    ...
    emails: [
      ...
      {
        subject: 'Ultima oportunidad + envío gratis',
        previewText: 'Te guardamos un beneficio especial',
        delayHours: 72,
        description: 'Oferta final con descuento o envío gratis para cerrar la venta.',
        purpose: 'Incentivo final para los más indecisos. Último intento de recuperación.',
      },
    ],
    bestPractices: [
      'Muestra imágenes reales de los productos abandonados en cada email.',
      'No ofrezcas descuento en el primer email, resérvalo para el tercero.',
      'Incluye un botón directo al carrito, no a la tienda general.',
      'Agrega reseñas del producto abandonado para generar confianza.',
    ],
  ...
  // 3. Post Purchase (high, retention)
  {
    ...
    expectedImpact: 'Aumento del 20-30% en tasa de reseñas. Tasa de recompra del 15-25% desde el email de cross-sell.',
  ...
  // 5. Browse Abandonment (high, revenue)
  {
    ...
    emails: [
      ...
      {
        subject: 'Más opciones que te van a gustar',
        previewText: 'Alternativas similares seleccionadas para ti',
        delayHours: 24,
        description: 'El producto visto más alternativas similares o complementarias.',
    ...
    bestPractices: [
      ...
      'Agrega reseñas del producto para dar confianza al indeciso.',
      'No incluyas descuento en browse abandonment, resérvalo para cart abandonment.',
    ],
  ...
  // 7. Sunset Flow (high, retention)
  {
    ...
    emails: [
      {
        ...
        purpose: 'Dar una oportunidad genuina de reconexión antes de la despedida.',
      },
      {
    ...
    bestPractices: [
      ...
      'Incluye un botón grande y claro de "Quiero seguir recibiendo emails".',
    ...
    emails: [
      {
        ...
        delayHours: 0,
        description: 'Felicitacion de cumpleanos con regalo exclusivo: descuento, envío gratis o producto.',
  ...
  // 9. Back in Stock (medium, revenue)
  {
    ...
    emails: [
      {
        subject: 'Ya está disponible lo que querías',
        previewText: 'Corre antes de que se agote otra vez',
        delayHours: 0,
        description: 'Notificación inmediata con imagen del producto, precio y botón de compra directa. Énfasis en urgencia.',
        purpose: 'Convertir inmediatamente el interés previo en compra antes de que se agote de nuevo.',
      },
    ],
    bestPractices: [
      'Envía de forma inmediata, cada minuto cuenta con stock limitado.',
      'Muestra cuántas unidades hay disponibles si es posible.',
      'Incluye un botón de compra directa, sin pasos intermedios.',
      'Permite que los clientes se suscriban a alertas de stock desde la página del producto.',
    ],
    expectedImpact: 'Tasa de conversión del 10-20%. Los clientes que pidieron alerta tienen intención de compra altísima.',
    productStrategy: 'none',
    discountEmail: null,
    defaultDiscountType: null,
    defaultDiscountValue: 0,
