...
// ---------------------------------------------------------------------------
// Register custom tools — loaded via customJS inside the Unlayer iframe.
// The customJS URL must be absolute (window.location.origin) because the
// iframe runs on editor.unlayer.com and cannot resolve relative paths.
// See public/unlayer-product-tool.js for the actual tool definitions.
// ---------------------------------------------------------------------------

/**
 * No-op. Custom tools are registered inside the Unlayer iframe via customJS.
 * This function exists for API compatibility.
 */
export function registerSteveMailTools(_editor: any, _products: ShopifyProduct[] = []) {
