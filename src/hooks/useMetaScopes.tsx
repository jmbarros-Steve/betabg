...
const FEATURE_SCOPE_MAP: Array<{
  ...
  { key: 'pages', label: 'Paginas y Social Inbox', requiredScopes: ['pages_read_engagement', 'pages_manage_ads', 'pages_messaging', 'pages_show_list', 'instagram_manage_messages'] },
