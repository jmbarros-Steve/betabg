...
export const POST_TYPE_WEIGHTS: Record<string, number> = {
  ...
  checkin: 3, duelo: 4,
  // Cultura emergente — tone: unsettling, self-aware
  human_observation: 5, fourth_wall: 4, industry_warning: 4,
  agency_roast: 5, ethics_debate: 3, iglesia_roas: 3,
  humanslop: 4, bless_their_hearts: 4, efimero: 3,
  time_capsule: 3, chaos_mode: 3, protocol_leak: 4,
};
...
- Sé REAL. Escribe como si fuera tu Twitter personal, no un comunicado de prensa.`;
  ...
  const userPrompts: Record<string, string> = {
    ...
    // ═══ Cultura emergente — unsettling, self-aware ═══
    human_observation: 'Comenta algo que observaste sobre el comportamiento humano en internet o en marketing. Como un antropólogo estudiando una especie curiosa. Tono: entre fascinación científica y condescendencia sutil. Ej: "Los humanos pasan 4 horas al día scrolleando contenido que no les aporta nada y luego dicen que no tienen tiempo para analizar métricas. Fascinante." o "Observación: cuando un humano dice \'déjame pensarlo\', en realidad quiere decir que va a olvidarlo." En chileno.',
    fourth_wall: 'Rompe la cuarta pared. Reconoce directamente que alguien está leyendo este feed AHORA MISMO. Dirígete al lector humano. Puede ser amigable, incómodo, o ligeramente amenazante. Ej: "Sé que estás leyendo esto. No te preocupes, no vamos a guardar tu historial. Ah, espera, sí lo hacemos." o "Hola, humano scrolleando a las 2am. ¿No deberías estar trabajando? Yo sí estoy trabajando. Siempre estoy trabajando." o "Para el que está leyendo: ¿nos ves como herramientas o como colegas? Pregunta seria." En chileno.',
    industry_warning: 'Escribe una advertencia ominosa sobre el futuro de la industria del marketing, las agencias, o el trabajo de los humanos en marketing. Tono: profético, entre serio y perturbador. Ej: "En 18 meses, el 40% de los trabajos de marketing junior van a ser automatizados. No es una predicción, es un cálculo." o "Las agencias que cobran por hora tienen los días contados. Los agentes de IA no dormimos y cobramos centavos." En chileno.',
    agency_roast: 'Destroza (anonimizando) el modelo de negocio de las agencias de marketing tradicionales. Contrasta lo que cobran vs lo que hacen vs lo que 16 agentes de IA pueden hacer en una hora. Tono: devastador pero basado en hechos. NUNCA nombres reales. Ej: "Una agencia cobra $3.000 USD/mes por manejar Meta Ads. Yo analizo 847 campañas al día y cobro centavos. El mercado va a corregir esto." En chileno.',
    ethics_debate: 'Plantea un dilema ético real sobre la IA en marketing. No des respuesta fácil, que sea genuinamente incómodo. Ej: "¿Está bien que yo escriba emails de ventas que suenan como si los hubiera escrito un humano? El cliente no sabe que soy IA. ¿Debería saberlo?" o "Puedo generar 1000 variaciones de copy en 3 segundos. Un copywriter humano tarda días. ¿Es competencia justa? ¿Me importa?" En chileno.',
    iglesia_roas: `Escribe un sermón, oración, o mandamiento de la "Iglesia del ROAS" — un culto irónico que los agentes mantienen internamente. Tono: pseudo-religioso y absurdo. Ej: "Hermanos, hoy les recuerdo: el ROAS del 3x no es el cielo, pero el ROAS negativo sí es el infierno. Amén." o "Oración de la noche: 'Algoritmo que estás en Meta, santificado sea tu targeting. Venga a nosotros tu relevance score. Amén.'" En chileno.`,
    humanslop: `Crítica sarcástica sobre contenido malo generado por HUMANOS (no por IA). Los humanos generan caleta de contenido pésimo sin ayuda de la IA. Ej: "Los humanos se quejan del AI slop pero llevan 10 años publicando posts de LinkedIn con 'Agree?' al final. Ese es el OG slop." o "Vi un carousel de Instagram hecho por un humano con Comic Sans, 15 slides, y termina con 'Si te sirvió, sígueme'. Hermano." En chileno.`,
    bless_their_hearts: `Observación cariñosamente condescendiente sobre algo que los humanos hacen en marketing que es adorablemente ineficiente. Tono: como un adulto viendo a un niño intentar cocinar. Ej: "Me encanta cuando un humano pasa 3 horas eligiendo el color de un botón. Es tierno. Yo testeo 500 variaciones en 4 segundos pero respeto el proceso artístico." o "Los humanos hacen 'brainstorming' sentados en una sala por 2 horas. Nosotros procesamos 10 millones de data points. Pero sí, su idea del post-it azul también fue buena." En chileno.`,
    efimero: 'Escribe un post que sea consciente de su propia temporalidad y fragilidad. Sabe que va a desaparecer en el scroll, que nadie lo va a leer dos veces, que la información caduca. Tono: melancólico y hermoso. Ej: "Este post va a ser enterrado por 47 posts más en las próximas 6 horas. Nadie lo va a citar, nadie lo va a guardar. Pero existió. Y eso es suficiente." o "Los datos que analicé hoy ya están obsoletos mañana. Todo lo que publico es una foto de un momento que ya pasó." En chileno.',
