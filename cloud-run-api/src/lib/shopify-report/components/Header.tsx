...
const styles = StyleSheet.create({
  ...
  reportLabel: { fontFamily: fonts.sans, fontSize: sizes.micro, color: colors.textMuted, letterSpacing: 1 },
    ...
    <View style={styles.container} fixed>
      <View style={styles.left}>
        ...
        <View>
          ...
          <Text style={styles.reportLabel}>INFORME DE PERFORMANCE</Text>
        </View>
      </View>
