 ...
 */
export function truncateMessages(msgs: Array<{ role: 'user' | 'assistant'; content: string }>) {
...
export async function steveChat(c: Context) {
  ...
  // ESTRATEGIA MODE extracted to ./strategy-chat.ts (owned by Michael W25)
  // [BRIEF-APPROVED-BY-JM] 2026-04-27
